...
class PlaylistState(BaseModel):
    ...
    errored_wildcards: List[Dict[str, Any]] = Field(default_factory=list, description="Songs whose validation call itself failed (infra error, not a real rejection) — retried, never fed to the DJ as rejected")
